...
const renderImports = (state, nextImages) => r("import React from \"react\";", state.hasImages && nextImages && "import Image from \"next/image\";", state.hasClasses && "import { classResolve } from \"./tsxlinkLib\";", nextImages && Object.entries(state.images).map(([id, path]) => `import ${id} from "${path}";`));
