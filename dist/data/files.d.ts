...
export declare const dirFiles: (dirPath: string, ignore: RegExp[], onlyExtension?: string) => Promise<FileData[]>;
export declare const zipFiles: (filePath: string, ignore: RegExp[], onlyExtension?: string) => Promise<FileData[]>;
